  ...
  return (
    <div className="conteiner-bg-black">
      ...
      <main>
          ...
          <article className="conteiner-text">
            ...
            <div className="sobre">
              ...
              <p className="sobre-text">
                ...
                aplicativos robustos até websites dinâmicos. Além do meu
                trabalho regular, também atuo como freelancer, oferecendo
                soluções criativas e sob medida para diversas necessidades.
                Estou sempre em busca de novos desafios e oportunidades para
                expandir meu conhecimento e contribuir para o sucesso de cada
                projeto. Seja bem-vindo ao meu portfólio, onde cada linha de
                código conta uma história de inovação e excelência técnica.
              </p>
            </div>
        ...
        <Conteiner>
          <div style={{ height: '30vh', width: '100%' }}>sfvsfv</div>
        </Conteiner>
      </main>
    </div>
  );
